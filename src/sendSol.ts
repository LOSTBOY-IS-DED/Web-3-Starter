...
async function Main(): Promise<void> {
    try {
        ...
        await connection.confirmTransaction({signature : airdropSignature , ...latestBlockHash} );  
        ...
        console.log('🔗 Explorer URL:', `https://explorer.solana.com/tx/${signature}?cluster=testnet`);
